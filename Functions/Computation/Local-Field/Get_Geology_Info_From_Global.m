function [THICKNESS, DEPTH, DENSITY, ABUNDANCE_U, ABUNDANCE_TH, ...
    MASS_ROCK, MASS_U, MASS_TH, SIGNAL_U, SIGNAL_TH, PRESSURE_TO_LAYER]...
    ...
    array_for_signal)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% File Name       : Get_Geology_Info_From_Global.m
